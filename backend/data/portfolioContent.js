 ...
 * ─────────────────────────────────────────────────────────────
 *  This is the canonical data for the whole site. It is
 *  seeded into MongoDB by scripts/seedDatabase.js.
 *
 *  Edit here, then re-run `npm run seed`.
 * ─────────────────────────────────────────────────────────────
 */
...
// Convenience export used by both the seeder and the embedder.
export const allContent = { about, skills, projects, experience, involvements, honors };
